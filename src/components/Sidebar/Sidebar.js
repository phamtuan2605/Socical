      ...
      <div className="sidebar">
        <nav className="sidebar-nav">
          <ul className="nav">
            ...
            <li className="nav-item nav-dropdown">
              <a className="nav-link nav-dropdown-toggle" href="#" onClick={this.handleClick.bind(this)}><i className="fa fa-search"></i> Tra cứu</a>
              <ul className="nav-dropdown-items">
                <li className="nav-item">
                  <NavLink to={'/contacts'} className="nav-link" activeClassName="active"><i className="icon-phone"></i> Danh bạ</NavLink>
                </li>
              </ul>
            </li>
